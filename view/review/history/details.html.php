...
?>
<h2 class="title"><?php echo Text::_("Mi revisión anterior"); ?></h2>
<div class="widget">
<p><?php echo Text::_("Del proyecto");?> <strong><?php echo $review->name; ?></strong><?php echo Text::_("de");?> <strong><?php echo $review->owner_name; ?></strong></p>
