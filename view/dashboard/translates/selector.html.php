...
<p><?php echo Text::_("El idioma original del proyecto es ");?><strong><?php echo $this['project']->lang_name ?></strong></p>
    <?php else : ?>
<p><?php echo Text::_("No tienes proyectos, solamente puedes traducir tu perfil.");?></p>
    <?php endif; ?>
<label for="selang"><?php echo Text::_("Idioma:");?></label>
