...
<h2 class="title"><?php echo Text::_("Acuerdo");?></h2>
</div>
-->

<div class="widget projects">
<h2 class="title"><?php echo Text::_("Cuentas bancarias del proyecto");?></h2>
<form method="post" action="/dashboard/projects/contract/save" >
    <input type="hidden" name="project" value="<?php echo $project->id; ?>" />
<p>
<label for="bank-account"><?php echo Text::_("Cuenta bancaria:");?></label><br />
    <input type="text" id="bank-account" name="bank" value="<?php echo $accounts->bank; ?>" style="width:350px;" />
</p>

<p>
<label for="paypal-account"><?php echo Text::_("Cuenta PayPal:");?></label><br />
