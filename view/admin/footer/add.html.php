    ...
    <form method="post" action="/admin/footer">
        ...
        <p>
            ...
            <select id="home-post" name="post">
                <option value="" ><?php echo Text::_("Seleccionar la entrada a publicar en el footer"); ?></option>
        ...
        <p><?php echo Text::_("Solo se está asignando al footer una entrada ya publicada. Para gestionar las entradas ir a la"); ?> <a href="/admin/blog" target="_blank"><?php echo Text::_("gestión de blog"); ?></a></p>
