...
<div class="widget board">
    <form method="post" action="/admin/faq/?filter=<?php echo $this['filter']; ?>">
        ...
        <?php if ($this['action'] == 'add') : ?>
            <label for="faq-section"><?php echo("Sección");?>:</label><br />
            <select id="faq-section" name="section">
                <option value="" disabled><?php echo("Elige la sección");?></option>
        ...
        <?php else : ?>
            <label for="faq-section"><?php echo("Sección");?>: <?php echo $this['sections'][$this['faq']->section]; ?></label><br />
            <input type="hidden" name="section" value="<?php echo $this['faq']->section; ?>" />
        <?php endif; ?>
        </p>

        <p>
            <label for="faq-title"><?php echo("Título");?>:</label><br />
            <input type="text" name="title" id="faq-title" value="<?php echo $this['faq']->title; ?>" />
        </p>

        <p>
            <label for="faq-description"><?php echo("Descripción");?>:</label><br />
            <textarea name="description" id="faq-description" cols="60" rows="10"><?php echo $this['faq']->description; ?></textarea>
        </p>

        <p>
            <label for="faq-order"><?php echo("Posición");?>:</label><br />
            <select name="move">
                <option value="same" selected="selected" disabled><?php echo("Tal cual");?></option>
                <option value="up"><?php echo("Antes de ");?></option>
                <option value="down"><?php echo("Después de ");?></option>
            </select>&nbsp;
