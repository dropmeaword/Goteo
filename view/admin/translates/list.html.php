...
?>
<a href="/admin/translates/add" class="button red"><?php echo Text::_('Nuevo proyecto para traducir'); ?></a>
        ...
        <div class="widget board">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="/admin/translates/edit/<?php echo $project->id; ?>/<?php echo $filter; ?>"><?php echo Text::_('[Editar]'); ?></a></td>
