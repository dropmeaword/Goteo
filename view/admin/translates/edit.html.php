...
<?php if ($this['action'] == 'edit') : ?>
    <h3 class="title"><?php echo Text::_("Traductores para el proyecto ") . $project->name ?></h3>
        <!-- asignar -->
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><a href="/admin/translates/unassign/<?php echo $project->id; ?>/<?php echo $filter; ?>&user=<?php echo $userId; ?>"><?php echo Text::_("[Desasignar]")?></a></td>
            </tr>
            <?php endforeach; ?>
            <tr>
                ...
                <td><a href="#" onclick="document.getElementById('form-assign').submit(); return false;"><?php echo Text::_("[Asignar]")?></a></td>
                </form>
            </tr>
        </table>
        <hr />
