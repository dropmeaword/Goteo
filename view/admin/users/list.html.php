...
?>
<a href="/admin/users/add" class="button red"><?php echo Text::_("Crear usuario"); ?></a>
...
<div class="widget board">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><a href="/admin/users/manage/<?php echo $user->id; ?>">[<?php echo Text::_("Gestionar"); ?>]</a></td>
                ...
                <td><a href="/admin/users/edit/<?php echo $user->id; ?>">[<?php echo Text::_("Editar"); ?>]</a></td>
                <td><a href="/admin/users/impersonate/<?php echo $user->id; ?>">[<?php echo Text::_("Suplantar"); ?>]</a></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
