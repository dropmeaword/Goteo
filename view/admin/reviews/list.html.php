        ...
        <div class="widget board">
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="/admin/reviews/edit/<?php echo $project->project; ?>/<?php echo $filter; ?>">[<?php echo Text::_("Editar"); ?>]</a></td>
                        <td><a href="/admin/reviews/report/<?php echo $project->project; ?>" target="_blank">[<?php echo Text::_("Ver informe"); ?>]</a></td>
                            <?php if ( $project->status > 0 ) : ?>
                        <td><a href="/admin/reviews/close/<?php echo $project->review; ?>/<?php echo $filter; ?>">[<?php echo Text::_("Cerrar"); ?>]</a></td>
                            <?php else : ?>
                        <td><?php echo Text::_("Revisión cerrada"); ?></td>
                            <?php endif; ?>
                        <?php else : ?>
                        <td><a href="/admin/reviews/add/<?php echo $project->project; ?>/<?php echo $filter; ?>">[<?php echo Text::_("Iniciar revision"); ?>]</a></td>
                        <td></td>
                        <?php endif; ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php if ($checker->ready) : ?><?php echo Text::_("Listo"); ?> <a href="/admin/reviews/unready/<?php echo $project->review; ?>/<?php echo $filter; ?>&user=<?php echo $user; ?>">[<?php echo Text::_("Reabrir"); ?>]</a><?php endif ?></td>
                    <td><a href="/admin/reviews/unassign/<?php echo $project->review; ?>/<?php echo $filter; ?>&user=<?php echo $user; ?>">[<?php echo Text::_("Desasignar"); ?>]</a></td>
                </tr>
                <?php endforeach; ?>
                <?php if ($project->status > 0) : ?>
                <tr>
