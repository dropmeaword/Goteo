...
<div id="lang-selector">
    ...
    <?php echo Text::_("Estas traduciendo al"); ?> <strong><?php echo $actual->name ?></strong>. <label for="selector"><?php echo Text::_("Cambiar a:"); ?></label>
    <?php else : ?>
    <?php echo Text::_("No has seleccionado un idioma al que traducir."); ?> <label for="selector"><?php echo Text::_("Traducir a:"); ?></label>
    <?php endif; ?>
    <select id="selector" name="lang" onchange="document.getElementById('selector-form').submit();">
<!--        <option value=""><?php echo Text::_("Seleccionar idioma de traducci&oacute;n"); ?></option> -->
