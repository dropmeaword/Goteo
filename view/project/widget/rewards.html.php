...
<div class="widget project-rewards collapsable" id="project-rewards">
    ...
    <h<?php echo $level + 1 ?> class="supertitle"><?php echo Text::_("Qué ofrece a cambio"); ?></h<?php echo $level + 1?>>
        ...
        <?php foreach ($project->social_rewards as $social) : ?>
            <li class="<?php echo $social->icon ?>">                
                ...
                <div class="license <?php echo htmlspecialchars($social->license) ?>">
                    <h<?php echo $level + 2 ?>><?php echo Text::_("Licencia"); ?></h<?php echo $level + 2 ?>>
    ...
    <div class="individual">
        ...
        <li class="<?php echo $individual->icon ?>">
            ...
            <div class="amount"><?php echo Text::_("Aportando"); ?> <span class="euro"><?php echo \amount_format($individual->amount); ?></span></div>
            ...
            <p><?php echo htmlspecialchars($individual->description)?></p>
                ...
                <strong><?php echo Text::_("Recompensa limitada"); ?></strong><br />
                <?php $units = ($individual->units - $individual->taken); 
                echo Text::html('project-rewards-individual_reward-units_left', $units); ?><br />
            <?php endif; ?>
            <div class="investors"><span class="taken"><?php echo $individual->taken; ?></span><?php echo Text::_("Cofinanciadores"); ?></div>
    ...
    <a class="more" href="/project/<?php echo $project->id; ?>/rewards"><?php echo Text::_("Ver más"); ?></a>
