        ...
        <?php if (!empty($posts)) : ?>
            <?php while ($post = $pagedResults->fetchPagedRow()) :
                ...
                <div class="widget post">
					...
					<div class="comments-num"><a href="/project/<?php echo $project->id; ?>/updates/<?php echo $post->id; ?>"><?php echo $post->num_comments > 0 ? $post->num_comments . ' ' .Text::_("Comentarios") : Text::_("Sin comentarios"); ?></a></div>
                </div>
            <?php endwhile; ?>
            <ul id="pagination">
