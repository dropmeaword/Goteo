...
?>        
    <div class="meter">
        <dl>            
            <dt class="minimum" style="width: <?php echo number_format(($minimum / $optimum) * 100) ?>%"><span><?php echo Text::_("Mínimo"); ?></span></dt>
            ...
            <dt class="optimum"><span><?php echo Text::_("Óptimo"); ?></span></dt>
